...
const Opdrachtgevers = () => {
  ...
  return (
    <div>
        <Header></Header>
        <Hero bg="homehero hero background-right right-hero" video={false} buttons={false} header_second="REGULIER ONDERWIJS" header="Morgen begint vandaag" text="Binnen het onderwijs staat de leerling centraal. Inspirerend en goed onderwijs geven, dat is het doel. Zodat zij zich kunnen ontwikkelen voor de dag van morgen."></Hero>
        ...
        <Contact header="“edukids stelt alleen onderwijsbanen voor die aansluiten op mijn wensen en ambities.”" number='82'></Contact>
        <Transparant header="Springplank naar de toekomst" text1="Als geen ander realiseert edukids voor wie we het allemaal doen: de leerling. Daarom hanteren wij maatschappelijke tarieven en eerlijke arbeidsvoorwaarden. Ook investeren wij doorlopend in het verbeteren van onze werkwijze zodat wij scholen zo goed mogelijk kunnen helpen bij het oplossen van onderwijsvragen." text2="En dat lukt alleen wanneer je de wensen en ambities van leraren centraal zet. Alleen dan vind je de juiste leraar voor de juiste klas en draag je bij aan de continuïteit en kwaliteit van het onderwijs. Want of het nou tijdelijk is of met uitzicht op een vaste aanstelling, iedere leerling heeft recht op het beste onderwijs."></Transparant>
        ...
        <Footer header="“Dankzij edukids kwam ik bij een ongelooflijk mooie school!”" text="Clio, leraar Engels binnen het voortgezet onderwijs"></Footer>
    </div>
  )
}
