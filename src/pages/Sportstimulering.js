...
const dataa = [
  {
      image: "images/buurtsportwerk.jpg",
  ...
  return (
    <div>
        ...
        <div className='samen-vid'>
          ...
          <Video src="292184122" image="sportstimulering.jpg"></Video>
        </div>
