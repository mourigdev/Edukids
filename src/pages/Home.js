...
const Home = () => {
  ...
  return (
    <div>
        <Header ></Header>
        <Hero  bg="hero" video={true} buttons={true} header_second="DÉ WERVINGSSPECIALIST VOOR HET ONDERWIJS EN DE KINDEROPVANG" header="Onderwijs is mensenwerk"></Hero>
