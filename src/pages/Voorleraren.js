...
const Opdrachtgevers = () => {
  ...
  const items = [
    ...
    },
    {
      ...
      content: 'Zij-instromers komen regelrecht uit het veld. Dit wordt door scholen enorm gewaardeerd, want je beschikt hierdoor over een schat aan praktijkervaring en dat is van directe meerwaarde voor de kwaliteit van het onderwijs. En leerlingen vinden deze praktijkvoorbeelden ook nog eens ontzettend leuk en nuttig. Volg je een lerarenopleiding of heb je deze in het verleden al afgerond? Neem dan contact met ons op. Flexwijs gaat ervoor om jouw onderwijsloopbaan zo snel mogelijk te lanceren, zodat je waardevolle werkervaring kunt opdoen in een baan die goed past bij jouw kennis en competenties.'
    }
  ];
  ...
  return (
    <div>
        ...
        <KnowMore two={false} header1="Waarom leraren kiezen voor Flexwijs" list1="Edukids is dé specialist in het werven van personeel voor het onderwijs, de kinderopvang en gemeenten, en biedt daarnaast services op het gebied van sportstimulering en educatieve programma's op het gebied van sport, natuur, wetenschap, cultuur, dans en meer." list2="Bij Edukids staan jouw wensen en ambities centraal en bieden we persoonlijk contact met betrokken loopbaanadviseurs." list3="Met uitgebreide ervaring binnen het PO, VO, SO en MBO begrijpen wij de behoeften van onze partnerscholen als geen ander. Hierdoor zijn wij in staat om de ideale match te vinden tussen kandidaten en werkplekken."
